...
- `kubeconfig`: *Optional.* A kubeconfig file.
    ...
    kubeconfig: |
      ...
      - cluster:
        ...
    ```
- `context`: *Optional.* The context to use when specifying a `kubeconfig` or `kubeconfig_file` param.
...
- `namespace`: *Optional.* The namespace to use. This param will override the namespace of source configuration.
